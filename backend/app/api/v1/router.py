...
from app.api.v1.routers import ai, appointments, auth, consent, documents, families, invites, lab_bookings, members, otp, prescriptions, profiles, providers, search, teleconsult, transfers, visibility
